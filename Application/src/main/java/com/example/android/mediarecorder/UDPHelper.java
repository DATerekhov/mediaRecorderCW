...
/**
 * Created by Dmitry Terekhov on 18.11.2016.
 */
...
public class UDPHelper extends Thread {
    ...
    public void send(String msg) throws IOException {
        ...
        DatagramPacket sendPacket2 = new DatagramPacket(sendData, sendData.length, InetAddress.getByName("192.168.1.35"), PORT);
